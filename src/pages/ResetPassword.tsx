...
import { ArrowRight, Lock, CheckCircle2, Sparkles } from 'lucide-react';
                        ...
                        <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/6 p-8 shadow-2xl shadow-slate-950/30 backdrop-blur-2xl sm:p-10">
                            ...
                            <div className="relative z-10 mb-10">
                                ...
                                <h1 className="max-w-lg text-4xl font-black tracking-tight text-white sm:text-5xl">
                                    Create a strong new password and get back into TaskFlow.
                                </h1>
                                <p className="mt-4 max-w-xl text-sm leading-6 text-slate-300 sm:text-base">
                                    Enter your new password below. You’ll be redirected to login once reset is complete.
                                </p>
                            </div>
                            ...
                            <div className="relative z-10 grid gap-4 sm:grid-cols-2">
                                ...
                                >
                                    <p className="text-sm font-medium text-slate-100">Secure password update</p>
                                </motion.div>
                                <motion.div
                                    initial={{ opacity: 0, y: 16 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    ...
                                    className="rounded-2xl border border-white/10 bg-slate-900/40 p-4 backdrop-blur-md"
                                >
                                    <p className="text-sm font-medium text-slate-100">One-time reset token</p>
                                </motion.div>
                            </div>
                        </div>
                    </motion.section>
                    ...
                    >
                        <div className="mx-auto max-w-md rounded-[2rem] border border-white/10 bg-white/92 p-8 text-slate-900 shadow-[0_30px_80px_rgba(2,6,23,0.45)] backdrop-blur-xl sm:p-10">
                            <div className="mb-8 text-center">
                                ...
                                <h2 className="text-3xl font-black tracking-tight text-slate-950">New password</h2>
                                <p className="mt-2 text-sm text-slate-600">Set your new password and secure your account.</p>
                            </div>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full rounded-2xl border bg-white px-4 py-3.5 text-slate-900 outline-none transition-all placeholder:text-slate-400 focus:border-cyan-400 focus:ring-4 focus:ring-cyan-500/15 ${errors.confirmPassword ? 'border-red-400' : 'border-slate-200'}`}
                                            placeholder="••••••••"
                                        />
